...
int
Write_DSP_Time(int port, int data5)
{
  int a, c;
...
void
Prog_DMA(int dmamode, int page, int curaddr, int curcnt)
{
...
void
Old_Calc_Addr(unsigned char* addr1)
{
  unsigned int a, b, c;
...
int
CTV_Output(unsigned char* bufaddr, int count, int sampling)
{
  int a, b;
  unsigned char c, d;
